  ...
  if (!ctx) {
    return {
      confirm: async (opts) => {
        ...
        console.warn('useConfirm: ConfirmProvider missing; treating confirm as cancelled.', message);
        return false;
      },
      alert: async (opts) => {
        const message = typeof opts === 'string' ? opts : opts?.message || '';
        console.warn('useConfirm: ConfirmProvider missing; alert not shown.', message);
        return true;
      },
    };
  }
