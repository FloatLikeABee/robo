...
### Key Questions
- How many call sites depend on ToolManager/tool_manager across src/api.py, agent_manager, gathering_service, scholar_forge_service?
...
### Risks
- Removing tools.py may break agent_manager, gathering_service, and API endpoints that rely on ToolManager
