# morph-engi-container Specification

## Purpose

Packages Project as one image so an operator can serve the API and UI together, check health, and keep SQLite and uploads on a data directory. Secrets stay in the environment.
