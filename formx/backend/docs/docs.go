...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.FormListResponse"
                        }
                    }
                }
            },
        ...
        "/api/v1/forms/{formId}/questions/{id}": {
            "put": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/api/v1/forms/{formId}/responses": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Since (unix ms)",
                        "name": "since",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Until (unix ms)",
                        "name": "until",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ResponseListResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/forms/{id}/questions/{questionId}/rules": {
            "get": {
                "produces": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.QuestionRule"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/v1/forms/{id}/questions/{questionId}/rules/{ruleId}": {
            "delete": {
                "tags": [
                    "rules"
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.PublicFormResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SubmitRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.CreateQuestionRequest": {
            ...
            "properties": {
                "config": {
                    "$ref": "#/definitions/models.QuestionConfig"
                },
                "required": {
                    "type": "boolean"
                },
        ...
        "models.FormResponse": {
            ...
            "properties": {
                "answers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AnswerEntry"
                    }
                },
                "form_id": {
                    "type": "integer"
        ...
        "models.Question": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "text, integer, select, multiselect, float, boolean, date, datetime, image, document, qrcode",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "models.QuestionRule": {
            ...
            "properties": {
                "condition": {
                    "description": "\"answered\" | \"not_answered\"",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "question_id": {
                    "description": "question this rule applies to",
                    "type": "integer"
                },
                "updated_at": {
                    "type": "string"
